...
积分体系后台-完成获取积分列表翻页，条数控制接口走通

积分体系后台-完成积分列表表格编辑操作，走通更新积分任务接口

任务中心新增积分配置-完成任务中心新建任务新增积分UI布局

LESS样式-遇到Antd中表单中嵌入组件，内容对齐不一致的问题。原因是表单item高度不固定，需要通过设置line-height和height来解决。



任务中心新增积分配置-完成新建任务积分表单校验 & 接口走通

互动雷达新增积分配置-熟悉他人代码，在原表单处完成积分UI布局

React框架学习-学习代数效应在React中的应用
