...
积分体系-积分看板、任务中心新增积分配置、互动雷达新增积分配置、积分任务配置中心 完成开发&接口联调

互动雷达新增积分配置-对接产品，针对积分校验提出三种完成情况提示，补充优化产品文档

积分体系-仔细对照UI设计稿和产品文档，提高明日提测质量

Vue学习-学习Vue2中的动态参数 & 指令缩写



积分体系-积分看板、任务中心新增积分配置、互动雷达新增积分配置、积分任务配置中心提测，预留一天修改阻塞性Bug。加快完成积分体系前台H5的开发。

Vue学习-学习Vue2中的计算属性和侦听器



许飞

极客云-积分体系后台联调 9.13-9.15

极客云-积分体系后台测试及阻塞性bug跟进 9.16
