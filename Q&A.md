...
+ 客户详情管理3.0-测试跟进&需求上线  (12.9~12.10)
+ 朋友圈运营需求优化-需求开发&需求上线 (12.9~12.12)
+ 专题页-专题页h5展示页开发，完成轮播图、富文本展示框、完成来电咨询电话呼叫开发  (12.12~12.13)

+ Vue学习-学习vue中::vdeep样式穿刺实现全局样式覆盖

+ 需求开发-专题页完成个人信息表单页开发，视频、海报等展示组件开发
+ 接口联调-获取专题页详情接口联调
...
- 客户详情管理3.0-测试跟进及bug修复。涉及适配归属顾问权限修改 & 集团版归属接口改动等。

- UI整改-客户群发查看详情由表单页面改侧边栏
- pnpm学习-pnpm常用指令学习
- 

+ 客户详情管理3.0-测试跟进及bug修复。集团版归属顾问cascader改为懒加载
+ UI整改-员工群发记录，任务中心UI修复迁移至集团版
...
+ 客户详情管理3.0-测试跟进及bug修复。归属顾问，批量迁移失败提示优化
+ UI整改-客户群发，渠道活码UI修复迁移至集团版
