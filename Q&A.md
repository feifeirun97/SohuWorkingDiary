...
- 昆明站紧急需求-敏感词新增（语义转标签+敏感词通知管理员）updateInformers 完成接口联调
- 昆明站紧急需求-集团版员工配置开发 bindGroupManager & groupManager & wechatDepartment & wechatUser 完成接口联调
- 极客云集团版-集团版周五上线，只开放员工配置菜单，完成基座路由配置和开放，部署测试环境




+ 昆明站紧急需求-敏感词新增（语义转标签+敏感词通知管理员）和 集团版员工配置 提测&Bug跟进
+ 极客云集团版-案场基座css样式与项目版有差异，等案场完成紧急修改主要样式规范
